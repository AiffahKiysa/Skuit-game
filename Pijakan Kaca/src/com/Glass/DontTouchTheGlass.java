...
public class DontTouchTheGlass implements ActionListener, MouseListener
{
	public final static int COLUMNS = 2, ROWS = 2, TILE_WIDTH = 250, TILE_HEIGHT = 300;

	public static DontTouchTheGlass dttg;
	...
	public DontTouchTheGlass()
	{
		JFrame frame = new JFrame("Don't Touch The Glass!");
	...
	public void render(Graphics g)
	{
		...
		if (!gameOver)
		{
			for (Tile tile : tiles)
			{
				g.setColor(tile.black ? Color.gray : Color.gray);
				g.fillRect(tile.x * TILE_WIDTH, tile.y * TILE_HEIGHT + tile.animateY, TILE_WIDTH, TILE_HEIGHT);
				g.setColor(tile.black ? Color.WHITE : Color.WHITE);
		...
		else
		{
			...
			g.drawString("Game Over!", TILE_WIDTH, TILE_HEIGHT);
		}
	}

	public static void main(String[] args)
	{
		dttg = new DontTouchTheGlass();
	}
